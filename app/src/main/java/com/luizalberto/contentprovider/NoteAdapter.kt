...
import com.luizalberto.contentprovider.database.NotesDatabeseHelper.Companion.DESCRIPTION_NOTES
import com.luizalberto.contentprovider.database.NotesDatabeseHelper.Companion.TITLE_NOTES

class NoteAdapter (private val listener: NoteClickedListener): RecyclerView.Adapter<NotesViewHolder>() {
